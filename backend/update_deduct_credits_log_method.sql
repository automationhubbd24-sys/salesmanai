-- Improved Credit Deduction Function with Transaction Logging (v4)
-- Updates the logging method to 'credit_deduction' to distinguish from money balance deductions.
...
BEGIN
  ...
  INSERT INTO public.payment_transactions (
    ...
    v_owner_email,
    1,
    'credit_deduction', -- CHANGED from balance_deduction
