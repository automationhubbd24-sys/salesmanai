        ...
        for (const fullTag of uniqueTags) {
            ...
            try {
                ...
                if (product) {
                    ...
                    let variantsDisplay = '';
                    const variantImages = [...resolvedContext.mediaImages];
                    const variantVideos = [...resolvedContext.mediaVideos];
                    if (selectedSku) {
                        ...
                        if (availableVariants.length > 0) {
                            ...
                            availableVariants.forEach((v, idx) => {
                                ...
                                if (v.image_url) variantImages.push(v.image_url);
                                if (v.video_url) variantVideos.push(v.video_url);
                            });
                        }
                    }
