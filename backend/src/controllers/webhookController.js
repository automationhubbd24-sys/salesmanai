            ...
            if (combinedImageAnalysis) {
                ...
                if (mergedVisualMatches.length > 0) {
                    const formattedMatches = mergedVisualMatches
                        ...
                        .join('\n');
                    combinedImageAnalysis += `[VISION ANALYSIS SEARCH RESULT - POSSIBLE MATCHES FROM OUR CATALOG]:\n${formattedMatches}\n\n`;
                } else {
                    combinedImageAnalysis += `[VISION ANALYSIS SEARCH RESULT]: No products found from the saved product vision analyses for this image.\n\n`;
                }
