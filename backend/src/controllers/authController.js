...
exports.getMyPayments = async (req, res) => {
    try {
        ...
        const configResult = await pgClient.query(
            'SELECT balance, daily_limit, daily_used, bonus_credit, permanent_credit, monthly_limit, monthly_used, message_credit FROM user_configs WHERE user_id::text = $1::text LIMIT 1',
            [String(userId)]
        );
