  ...
  const faqs = [
    {
      ...
      answer: t(
        "Our AI uses advanced computer vision to analyze images sent by customers. It cross-references these with your product database to identify items, prices, and product availability automatically.",
