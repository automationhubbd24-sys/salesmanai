    ...
    <section id="problem-solution" className="py-24 bg-background relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gradient-to-br from-indigo-900/10 to-purple-900/10 rounded-[3rem] p-1 md:p-1.5 shadow-[0_0_80px_rgba(79,70,229,0.05)]"
        >
          <div className="bg-card rounded-[2.8rem] p-8 md:p-16 flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              <h3 className="text-2xl md:text-4xl font-black text-foreground mb-6 leading-tight">
                Salesman<span className="text-[#A855F7]">Chatbot</span> {t("is your superhuman", "আপনার সুপারহিউম্যান")}<br />
                <span className="text-indigo-600 dark:text-indigo-400/80">{t("Sales Agent that never sleeps", "সেলস এজেন্ট যে কখনো ঘুমায় না")}</span>
              </h3>
            ...
            <div className="flex-1 relative">
               ...
               <div className="relative bg-background border border-border rounded-2xl p-6 shadow-2xl">
                  <div className="flex items-center gap-3 mb-6 border-b border-border pb-4">
                    ...
                    <div>
                      <div className="text-xs font-bold text-foreground">Salesman AI</div>
                      <div className="text-[10px] text-emerald-600 dark:text-emerald-500/80 flex items-center gap-1">
                  ...
                  <div className="space-y-4">
                    <div className="bg-secondary rounded-xl p-3 max-w-[80%]">
                      <div className="text-[10px] text-muted-foreground mb-1">Customer</div>
                      <div className="text-xs text-foreground/80">How much for the iPhone 15?</div>
                    </div>
                    <div className="bg-indigo-600/10 rounded-xl p-3 max-w-[80%] ml-auto border border-indigo-500/20">
                      <div className="text-[10px] text-indigo-600 dark:text-indigo-400/80 mb-1">Salesman AI</div>
                      <div className="text-xs text-foreground/90 italic font-medium">Recognizing product...</div>
                    </div>
                  </div>
               </div>
            </div>
