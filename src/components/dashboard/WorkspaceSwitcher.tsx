  ...
  return (
    <div className="px-2 mb-2 relative z-50">
        ...
        <PopoverTrigger asChild>
            ...
            role="combobox"
            aria-expanded={open}
            className="w-full justify-between h-12 px-3 border border-white/10 bg-[#0f0f0f]/80 hover:border-[#00ff88]/60 hover:bg-[#00ff88]/10 hover:text-[#00ff88] transition-all text-sm font-medium"
            >
            <div className="flex items-center gap-2 truncate">
                <div className="p-1.5 rounded-md bg-[#00ff88]/10 border border-[#00ff88]/40">
                    <CurrentIcon className="h-4 w-4 text-[#00ff88]" />
                </div>
        ...
        <PopoverContent className="w-[220px] p-0 z-[1000] bg-white text-black border border-black/10 shadow-lg" align="start">
            <Command>
            <CommandList>
