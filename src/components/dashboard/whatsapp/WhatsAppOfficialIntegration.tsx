      ...
      <CardHeader className="pb-3">
        <div className="flex justify-between items-start">
          <div>
            ...
            <CardDescription>
              Connect your official WhatsApp Business account (Cloud API)
            </CardDescription>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-blue-500/10 border border-blue-500/20 p-4 rounded-lg">
              <p className="text-sm text-blue-400">
                Using official API allows you to keep your WhatsApp logged in on your mobile while the chatbot handles customer queries.
              </p>
            </div>
            <Button 
