...
const ResetPassword = () => {
  ...
  const handleSendCode = async () => {
    ...
    setLoading(true);
    try {
      const res = await secureFetch(`${BACKEND_URL}/api/auth/password/reset/request`, {
        method: "POST",
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await secureFetch(`${BACKEND_URL}/api/auth/password/reset/verify`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleReset = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await secureFetch(`${BACKEND_URL}/api/auth/password/reset/complete`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
