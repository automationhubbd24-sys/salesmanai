...
import { RefreshCw, Plus, QrCode, Trash2, Play, Pause, Server, Zap, Download, Smartphone, AlertTriangle, FileText, LayoutDashboard, Loader2, Gift } from "lucide-react";
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        {sessions.map((session) => (
          <Card key={session.name} className="relative overflow-hidden bg-[#0f0f0f]/80 backdrop-blur-sm border border-white/10 hover:border-[#00ff88]/40 hover:shadow-[0_0_35px_rgba(0,255,136,0.2)] transition-all duration-300 group rounded-2xl">
                ...
                <div className="mt-3 flex flex-col items-center p-4 rounded-xl bg-white border-2 border-slate-800 shadow-inner animate-in fade-in zoom-in duration-300 relative group">
                    {qrCodeUrl ? (
                        <>
                            ...
                            <div className="flex flex-col items-center gap-2 mt-2 w-full justify-center">
                                <div className="flex items-center gap-2">
                                    <p className="text-[10px] text-slate-500 font-medium uppercase tracking-widest">Scan with WhatsApp</p>
                                    <Button 
                                        size="icon" 
                                        variant="ghost" 
