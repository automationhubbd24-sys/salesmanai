    ...
    try {
      ...
      if (isMountedRef.current) {
          ...
          if (cheapEngine === false) {
            ...
            isManaged = dbApiKey === MANAGED_SECRET_KEY || (isActive && !dbApiKey);
          }
                                ...
                                {(detailedCredits?.subscription_plan !== 'none' || detailedCredits?.permanent_credit > 0 || messageCredit > 0) ? (
                                    <div className="flex items-center gap-4 rounded-xl bg-gradient-to-br from-white to-purple-50/20 p-3 shadow-sm border border-purple-100 dark:from-purple-900/20 dark:to-purple-950/20 dark:border-purple-800/30">
                                        <div className="text-right flex-1">
                                            ...
                                            <div className="text-sm font-black text-purple-700 dark:text-purple-400 leading-none">
                                                ...
                                                {(selectedPlan === '1000' || selectedPlan === 'm1000') && "Starter (500 Daily)"}
                                                {(selectedPlan === '5000' || selectedPlan === 'm3000') && "Pro (2k Daily)"}
                                                {(selectedPlan === '10000' || selectedPlan === 'm7500') && "Enterprise (5k Daily)"}
                                                {selectedPlan === 'p150' && "Basic Credits (1k)"}
                                                {selectedPlan === 'p700' && "Value Pack (5k)"}
                                                {selectedPlan === 'p1350' && "Bulk Saver (10k)"}
                                    ...
                                    <div className="flex items-center justify-between p-3 rounded-xl border border-dashed border-purple-200 bg-purple-50/20 dark:border-purple-800/30 dark:bg-purple-900/10">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h3 className="text-xs font-bold text-purple-900 dark:text-purple-100">No Active Plan</h3>
                                                <p className="text-[10px] text-muted-foreground">Unlock AI by choosing a plan.</p>
                                            </div>
                                        </div>
                                        <Button 
                                            type="button" 
                            ...
                            <DialogContent className="max-w-4xl bg-[#0b0b0b] border-white/10 text-white">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            {[
                                                { id: 'p150', name: 'Basic Credits', price: '150', msg: '1,000 Messages' },
                                                { id: 'p700', name: 'Value Pack', price: '700', msg: '5,000 Messages', popular: true },
                                                { id: 'p1350', name: 'Bulk Saver', price: '1,350', msg: '10,000 Messages' }
                                            ].map((plan) => (
                                                <div 
                                                    key={plan.id}
