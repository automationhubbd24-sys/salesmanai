...
import { Save, Bot, Lock, Sparkles, Key, Check, Image, Clock, Infinity as InfinityIcon } from "lucide-react";
                        ...
                        <Dialog open={isPricingOpen} onOpenChange={setIsPricingOpen}>
                            <DialogContent className="max-w-4xl bg-[#0b0b0b] border-white/10 text-white">
                                ...
                                <DialogFooter className="mt-6">
                                    <Button variant="ghost" onClick={() => setIsPricingOpen(false)} className="text-gray-400 hover:text-white">Cancel</Button>
                                    <Button onClick={handlePurchaseCredits} className="bg-[#00ff88] text-black font-black px-8 hover:bg-[#00e67a] shadow-[0_10px_30px_rgba(0,255,136,0.2)]">Confirm & Pay</Button>
                                </DialogFooter>
                            </DialogContent>
                        </Dialog>
                    </div>
